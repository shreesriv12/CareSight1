...
//       // Fetch assigned nurse if exists
...
//                     {patientData?.name || user.full_name}
//                   </p>
//                 </div>
...
//                   ) : (
//                     <p className="mt-1 text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
//                       {patientData?.communication_method}
//                     </p>
//                   )}
//                 </div>
//               </div>
...
//                   <p className="mt-1 text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
//                     {assignedNurse?.full_name || 'Not assigned'}
//                   </p>
//                 </div>
...
//                     <p className="text-sm text-yellow-800 mb-2">Read-only for patients</p>
...
//                   <p className="mt-1 text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">
//                     {patientData?.diagnosis || 'Not specified'}
//                   </p>
//                 </div>
//               </div>
//             </div>
